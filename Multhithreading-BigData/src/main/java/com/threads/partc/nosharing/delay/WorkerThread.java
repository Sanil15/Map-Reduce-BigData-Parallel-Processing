...
public class WorkerThread extends Thread {
	...
	// Otherwise if Station Id exists it makes a delayed(invoking Fibonacci of 17 first)  
	// update to map's entry by accumulating temperature values and incrementing the record count for that station.
	@Override
	public void run() {
